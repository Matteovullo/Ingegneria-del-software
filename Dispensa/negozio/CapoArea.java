...
public class CapoArea extends Manager {
	...
	/**
	 * Ritorna l'area di cui il manager � a capo
	 * 
	 * @return l'area
	 */
	public Area getArea() {
	 ...
	 * Verifica se l'addetto � gi� presente nell'area o meno
	 * 
	...
	public void aggiungiAddetto(AddettoVendite a) {
		if(addetti.contains(a)) {
			System.out.println("L'addetto " + a.getNome() + " " + a.getCognome() + " � gi� presente in quest'area");
			return;
		}
		addetti.add(a);
	}
	 ...
	 * se e solo se questo � assegnato a quest'area
	 * 
	 * @param a l'addetto da r�muovere
	 */
	public void rimuoviAddetto(AddettoVendite a) {
		if(!addetti.remove(a)) {
			System.out.println("L'addetto " + a.getNome() + " " + a.getCognome() + " non � presente in quest'area");
		}
	}

	/**
	 * Modifica lo stipendio di un addetto dell'area
	 * se e solo se questo � assegnato all'area del manager
	 * 
	...
	public void modificaStipendio(AddettoVendite  a, Double s) {
		if(addetti.contains(a))
			...
			System.out.println("Il manager " + this.getNome() + " " + this.getCognome() + " non pu� modificare lo stipendio"
