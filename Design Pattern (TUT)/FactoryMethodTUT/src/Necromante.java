...
public class Necromante implements Personaggio{
    ...
    public void attacca(Personaggio enemy){
        System.out.println(getClasse() + " -> attacca " +
        enemy.getClasse());

        if(!enemy.vivo()){
            System.out.println("Il personaggio che vuoi attaccare è gia morto.\n");
            return;
        }
        ...
        enemy.damage(danno);
        System.out.println(getClasse() + " ha inflitto " + danno +
        " danni a " + enemy.getClasse() + "\n"); 
    }
    ...
    public void cura(){
        if(!vivo()){
            System.out.println(getClass() + " è morto quindi non puo' curarsi.\n");
            return;
        }
